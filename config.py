...
def load_config():
    ...
    config = {
        ...
        "MAX_GOOGLE_SEARCH": get_int_env("MAX_GOOGLE_SEARCH", 3),
        "GOOGLE_SEARCH_NUM_RESULTS": get_int_env("GOOGLE_SEARCH_NUM_RESULTS", 3),
        "MAX_SCRAPE_DEPTH": get_int_env("MAX_SCRAPE_DEPTH", 3),
